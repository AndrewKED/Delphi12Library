...
{$IF DEFINED(CLR)}
    ...
    procedure LookupKeyword(Handle: LongInt; const HelpFileName: string;
      LinkPtr: DWORD); overload;
    procedure DisplayTextPopup(Handle: LongInt; Data: HH_Popup); overload;
    procedure DisplayTextPopup(Handle: LongInt; Data: DWORD); overload;
{$ELSE}
    procedure LookupALink(Handle: LongInt; const HelpFileName: string;
      LinkPtr: PHH_AkLink);
    procedure LookupKeyword(Handle: LongInt; const HelpFileName: string;
...
procedure THtmlHelpViewer.DisplayTextPopup(Handle: LongInt; Data: HH_Popup);
var
  FileName: string;
begin
...
procedure THtmlHelpViewer.DisplayTextPopup(Handle: LongInt; Data: DWORD);
var
  FileName: string;
begin
  HtmlHelp(Handle, FileName, HH_DISPLAY_TEXT_POPUP, Data);
