...
---------------------------------------------------------------------------*)
procedure fft (
    NumSamples:   Integer;   { must be a positive integer power of 2 }
...
procedure fftS (
    NumSamples:   Integer;
    var  RealIn:   array of single;
    var  ImagIn:   array of single;
    var  RealOut:  array of single;
    var  ImagOut:  array of single );
...
--------------------------------------------------------------------------*)
procedure CalcFrequency (
    NumSamples: Integer;       { can be any positive integer }
    FrequencyIndex: Integer;   { must be in the range 0 .. NumSamples-1 }
    var  RealIn:  array of double;
    var  ImagIn:  array of double;
    var  RealOut: double;
    var  ImagOut: double );
...
procedure fftS (
    ...
    var  ImagOut:  array of single );
begin
    FourierTransformS ( 2*PI, NumSamples, RealIn, ImagIn, RealOut, ImagOut );
end;
...
type
    realArray = array [0..0] of double;
var
    RealTemp, ImagTemp: ^realArray;
...
procedure CalcFrequency (
    NumSamples: Integer;       { must be integer power of 2 }
    FrequencyIndex: Integer;   { must be in the range 0 .. NumSamples-1 }
    var  RealIn:  array of double;
    var  ImagIn:  array of double;
    var  RealOut: double;
