...
function GetServiceStatus(sMachine : String;
                          sService : String) : Cardinal;
function ServiceStart(sMachine : String;
                      sService : String) : Boolean;
function ServiceStop(sMachine : String;
                     sService : String) : Boolean;
...
//
//  I/P       : sMachine : String - Machine name e.g. \SERVER
//                '' means the local machine.
//
//              sService : String - The service name
//
//  O/P       : Cardinal - Service status.
//
//  OPERATION :
//
//  UPDATED   : 2018-09-02
...
//              sService : String - The service name
//
//  O/P       : Boolean - TRUE if successful.
//
//  OPERATION :
//
//  UPDATED   : 2018-08-28
